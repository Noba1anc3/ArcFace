...
class face_learner(object):
    def __init__(self, conf, inference=False):
        if conf.use_mobilfacenet:
            ...
            print('*********************************{}_{} Generated*********************************'.format(conf.net_mode, conf.net_depth))
            print('')
    ...
    def train(self, conf, epochs):
        #self.load_state(conf, 'ir_se50.pth', True, True)
        self.model.train()
        running_loss = 0.
        for e in range(epochs):
            print('epoch {} started'.format(e))
            if e == (self.milestones[0] or self.milestones[1] or self.milestones[2]):
                self.schedule_lr()
